...
import { RequirementCard } from "@/app/requirements/requirement-card";
...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "Browse open AI project requirements from UK businesses on AI Jobs Market.",
  path: "/requirements",
});
        ...
        {requirements.length === 0 ? (
          <Card>
            <CardContent className="px-6 py-16 text-center">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm text-muted">
                Be the first to post an AI requirement, or check back as
                businesses add new opportunities.
              </p>
              <Button asChild className="mt-6">
                <Link href="/dashboard/requirements/new">Post a requirement</Link>
              </Button>
            </CardContent>
          </Card>
        ) : (
          <>
            <p className="mb-6 text-sm text-muted">
              {requirements.length} open requirement
