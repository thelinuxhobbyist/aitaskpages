...
export function ExternalLinksField({ initialLinks = [] }: Props) {
  ...
  return (
    <div className="space-y-3">
      <div>
        <Label>Other profile links</Label>
        <p className="mt-1 text-xs text-muted">
          Optional. Add profiles on other sites (Behance, X, personal site,
          directory listings, etc.). One URL per row — up to {MAX_EXTERNAL_LINKS}.
        </p>
      </div>
